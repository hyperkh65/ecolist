  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '20px' }}>
        <h1 style={{ fontSize: '42px', fontWeight: 900, marginBottom: '24px', lineHeight: 1.3 }}>
          💡 초등학생도 이해하는 <br/>
      ...
      <section style={{ border: '1px solid rgba(255,255,255,0.1)', padding: '40px', borderRadius: '20px', background: 'rgba(255,255,255,0.02)' }}>
        <h2 style={{ fontSize: '30px', color: '#60a5fa', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Lightbulb size={36} /> 제 1장: 디밍(Dimming)이란 무엇일까요?
        </h2>
        <p style={{ fontSize: '18px', lineHeight: 1.8, color: '#cbd5e1', marginTop: '20px' }}>
          화장실 세면대에서 수도꼭지를 살살 돌리면 물이 졸졸 나오고, 꽉 틀면 콸콸 나오죠? 
          <br/><br/>
          전등도 마찬가지예요! 전기를 100만큼 다 주면 눈이 부시게 밝지만, 전기를 50만큼만 주면 부드러운 빛이 됩니다. 
          이렇게 <b>전기의 양을 조절해서 빛의 밝기를 마음대로 바꾸는 것</b>을 바로 **'디밍(Dimming)'**이라고 불러요.
        </p>
      ...
      {/* Chapter 2 */}
      <section style={{ border: '1px solid rgba(255,255,255,0.1)', padding: '40px', borderRadius: '20px', background: 'rgba(255,255,255,0.02)' }}>
        <h2 style={{ fontSize: '30px', color: '#c084fc', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Cpu size={36} /> 제 2장: IC - 빛을 지휘하는 조그만 꼬마 기관사
        </h2>
        <p style={{ fontSize: '18px', lineHeight: 1.8, color: '#cbd5e1', marginTop: '20px' }}>
        ...
        <div style={{ marginTop: '40px', background: '#0f172a', padding: '30px', borderRadius: '16px', border: '1px solid #1e293b' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 40px', gap: '20px' }}>
            {/* Battery Source */}
            ...
            {/* The Road and Dots */}
            <div style={{ flex: 1, height: '40px', background: '#1e293b', borderRadius: '20px', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center' }}>
              <div 
                style={{
            ...
            {/* IC Brain */}
            <div style={{ textAlign: 'center', background: '#3b82f6', padding: '16px', borderRadius: '12px' }}>
              <Cpu size={40} color="#fff" />
              <div style={{ fontWeight: 'bold' }}>IC 칩</div>
            </div>

            {/* LED Bulb */}
            <div style={{ marginLeft: '20px', textAlign: 'center' }}>
              <div style={{ transition: 'all 0.5s', opacity: icFlowSpeed > 1 ? 1 : 0.3, transform: icFlowSpeed > 1 ? 'scale(1.2)' : 'scale(1)' }}>
                <Lightbulb size={60} color="#eab308" />
              </div>
              <div>LED 전등</div>
            </div>
          </div>
      ...
      {/* Chapter 3 */}
      <section style={{ border: '1px solid rgba(255,255,255,0.1)', padding: '40px', borderRadius: '20px', background: 'rgba(255,255,255,0.02)' }}>
        <h2 style={{ fontSize: '30px', color: '#2dd4bf', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Activity size={36} /> 제 3장: 아날로그 방식 (0-10V 디밍의 원리)
        </h2>
        <p style={{ fontSize: '18px', lineHeight: 1.8, color: '#cbd5e1', marginTop: '20px' }}>
        ...
        <div style={{ marginTop: '40px', background: '#0f172a', padding: '30px', borderRadius: '16px', border: '1px solid #1e293b' }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <input 
              ...
              style={{ width: '60%', height: '8px', cursor: 'pointer', accentColor: '#2dd4bf' }} 
            />
            <div style={{ fontSize: '32px', fontWeight: 900, color: '#2dd4bf', marginTop: '20px' }}>{voltage} V 전송 중!</div>
          </div>

          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px' }}>
            {/* IC thinking */}
            <div style={{ position: 'relative', width: '200px', height: '200px', border: '4px solid #334155', borderRadius: '16px', display: 'flex', alignItems: 'flex-end', padding: '4px' }}>
              <div style={{ 
                width: '100%', 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
               <Lightbulb size={120} color={voltage > 2 ? '#2dd4bf' : '#475569'} style={{ opacity: voltage/10, transition: 'all 0.3s' }} />
      ...
      {/* Chapter 4 */}
      <section style={{ border: '1px solid rgba(255,255,255,0.1)', padding: '40px', borderRadius: '20px', background: 'rgba(255,255,255,0.02)' }}>
        <h2 style={{ fontSize: '30px', color: '#f87171', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <AlertTriangle size={36} /> 제 4장: 0-10V 방식의 치명적 단점 (전기가 길을 잃다)
        </h2>
        <p style={{ fontSize: '18px', lineHeight: 1.8, color: '#cbd5e1', marginTop: '20px' }}>
        ...
        <div style={{ marginTop: '40px', background: '#0f172a', padding: '30px', borderRadius: '16px', border: '1px solid #1e293b' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '30px' }}>
             <button onClick={() => setWireThickness(!wireThickness)} style={{ padding: '12px 24px', background: wireThickness ? '#22c55e' : '#64748b', color: '#fff', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '16px', fontWeight: 'bold' }}>
               {wireThickness ? '두껍고 좋은 전선 사용 중 (전압 안 깎임!)' : '얇고 싼 전선 사용 중 (버튼을 눌러 교체하세요)'}
             </button>
          </div>

          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', padding: '20px', background: '#1e293b', borderRadius: '12px' }}>
             <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#3b82f6', marginBottom: '10px' }}>스위치: 10V 발사!</div>
             ...
             {[1, 2, 3, 4, 5].map((num) => {
               ...
               return (
                 <div key={num} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                   <div style={{ width: '100px', height: wireThickness ? '12px' : '4px', background: '#475569', marginBottom: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                     <div style={{ width: '100%', height: '2px', background: wireThickness ? '#22c55e' : '#f87171' }}></div>
                   </div>
                   <Lightbulb size={48} color={receivedV > 4 ? '#eab308' : '#64748b'} style={{ opacity: receivedV/10 }} />
                   <div style={{ marginTop: '10px', fontSize: '14px' }}>조명 {num}번</div>
                   <div style={{ fontSize: '16px', fontWeight: 'bold', color: receivedV === 10 ? '#22c55e' : '#f87171' }}>{receivedV}V 도착</div>
                 </div>
               )
             })}
          </div>
      ...
      {/* Chapter 5 */}
      <section style={{ border: '1px solid rgba(255,255,255,0.1)', padding: '40px', borderRadius: '20px', background: 'rgba(255,255,255,0.02)' }}>
        <h2 style={{ fontSize: '30px', color: '#facc15', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Wind size={36} /> 제 5장: 완벽한 기술, PWM 디밍 (엄청 빠른 깜빡임!)
        </h2>
        <p style={{ fontSize: '18px', lineHeight: 1.8, color: '#cbd5e1', marginTop: '20px' }}>
      ...
      {/* Chapter 6 */}
      <section style={{ border: '1px solid rgba(255,255,255,0.1)', padding: '40px', borderRadius: '20px', background: 'rgba(255,255,255,0.02)' }}>
         <h2 style={{ fontSize: '30px', color: '#fb923c', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <ShieldCheck size={36} /> 제 6장: 해상도의 마법 (8비트 vs 16비트)
        </h2>
        <p style={{ fontSize: '18px', lineHeight: 1.8, color: '#cbd5e1', marginTop: '20px' }}>
        ...
        <div style={{ marginTop: '40px', background: '#0f172a', padding: '30px', borderRadius: '16px', border: '1px solid #1e293b' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginBottom: '30px' }}>
             <button onClick={() => resetBitSim(8)} style={{ padding: '12px 24px', background: '#475569', color: '#fff', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '16px', fontWeight: 'bold' }}>
               8비트 (저가형) 뚝뚝 끊김
             </button>
             <button onClick={() => resetBitSim(16)} style={{ padding: '12px 24px', background: '#fb923c', color: '#fff', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '16px', fontWeight: 'bold' }}>
               16비트 (도서관, 호텔급) 스무스
             </button>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '40px' }}>
            {/* The Graph */}
            <div style={{ position: 'relative', width: '300px', height: '200px', borderLeft: '2px solid #64748b', borderBottom: '2px solid #64748b' }}>
              <div 
                style={{ 
              ...
              />
              <div style={{ position: 'absolute', bottom: '-25px', width: '100%', textAlign: 'center', color: '#cbd5e1' }}>시간이 지나며 불 끄기...</div>
            </div>

            {/* Bubble */}
            <div style={{ width: '150px', height: '150px', borderRadius: '50%', background: `rgba(251, 146, 60, ${bitProgress/100})`, display: 'flex', alignItems: 'center', justifyContent: 'center', transition: bitDepth === 16 ? 'background 0.05s linear' : 'none' }}>
               <Lightbulb size={60} color="#fff" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Chapter 7 */}
      <section style={{ border: '1px solid rgba(255,255,255,0.1)', padding: '40px', borderRadius: '20px', background: 'rgba(255,255,255,0.02)' }}>
         <h2 style={{ fontSize: '30px', color: '#ef4444', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Key size={36} /> 제 7장: 유령등 현상과 릴레이 스위치 방어법
        </h2>
        <p style={{ fontSize: '18px', lineHeight: 1.8, color: '#cbd5e1', marginTop: '20px' }}>
        ...
        <div style={{ marginTop: '40px', background: '#0f172a', padding: '30px', borderRadius: '16px', border: '1px solid #1e293b' }}>
          <div style={{ textAlign: 'center', marginBottom: '20px' }}>
             <button onClick={() => setRelayOn(!relayOn)} style={{ padding: '16px 32px', background: relayOn ? '#ef4444' : '#22c55e', color: '#fff', borderRadius: '12px', border: 'none', cursor: 'pointer', fontSize: '20px', fontWeight: 'bold', boxShadow: '0 4px 15px rgba(0,0,0,0.3)' }}>
               {relayOn ? '릴레이 차단함 (완전소등 타락!)' : '릴레이 열려있음 (유령등 발생 대기)'}
             </button>
          </div>

          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '40px', background: '#1e293b', borderRadius: '16px', gap: '60px' }}>
             <div style={{ textAlign: 'center' }}>
