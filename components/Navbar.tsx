      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div className="desktop-nav" style={{ 
            ...
            background: scrolled ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.05)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ position: 'relative' }}>
              <button 
                ...
                style={{
                  ...
                  border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer', height: 44, padding: '0 12px', borderRadius: '22px',
                  color: '#ffffff', display: 'flex', alignItems: 'center', gap: 6, transition: '0.3s'
                }}
              >
              ...
              {langMenuOpen && (
                <div style={{
                  ...
                  background: 'var(--bg-card)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16,
                  boxShadow: '0 10px 30px rgba(0,0,0,0.5)', overflow: 'hidden', zIndex: 100,
                  minWidth: 140
                }}>
                  {(Object.keys(FLAG_ICONS) as Language[]).map((l) => (
                    <button
                      ...
                      style={{
                        width: '100%', padding: '12px 16px', border: 'none', background: lang === l ? 'rgba(255,255,255,0.05)' : 'none',
            ...
            <Link href="/cart" style={{ 
              background: 'rgba(255,255,255,0.08)', 
              border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer', width: 44, height: 44, borderRadius: '50%',
              color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', transition: '0.3s',
              textDecoration: 'none'
            }}>
